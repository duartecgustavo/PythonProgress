...
# Se ele ainda vai se alistar ao exercito / Se ele ja deve se alista ao exercito / Se ja passou da hora de ele se alistar
# Mostre também o tempo que falta ou que passou da sua idade de alistamento.

from datetime import date

print('\033[32mBEM VINDO AO PROGRAMA DE ALISTAMENTO AO EXERCITO \033[4m ANTI-FACISTA DO BRASIL\033[m')

nome = input('Primeiramente queremos saber seu \033[4mnome completo\033[m! ')
...
Até mais!!!''')
    ...
    print(f'''\n\033[34m{nome.title().split()[0]}\033[m chegou a sua hora de \033[31mquebrar alguns Facistas na porrada!!!\033[m
          \033[4Se apresente na sub-prefeitura\033[m mais proxima com :
          \033[32m- RG
