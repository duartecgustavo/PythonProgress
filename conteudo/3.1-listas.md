...
* Pode observar a utilização no **Desafio 81 - analizando dados [:link:](https://github.com/duartecgustavo/Python-Progress/blob/master/desafios/Mundo%203/Ex081.py)**.
